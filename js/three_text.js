...
export function textBoxProperties( boxProps, text, textProps, matProps, animProps=undefined, listConfig=undefined, onCreated=undefined, padding=0.01, isPortal=false){
  return {
    'type': 'TEXT_BOX',
    'boxProps': boxProps,
    'text': text,
